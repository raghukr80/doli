 ...
 */
class pdf_muscadetIGST extends ModelePDFSuppliersOrders
{
    var $db;
    var $name;
    var $description;
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop=0, $hidebottom=0, $currency='')
	{
        ...
        if (empty($conf->global->MAIN_GENERATE_DOCUMENTS_WITHOUT_VAT))
        {
			...
			if (empty($hidetop))
			{
    			...
    			$pdf->MultiCell($this->posxup-$this->posxtva+3,2, $outputlangs->transnoentities("IGST"),'','C');
			}
        }
