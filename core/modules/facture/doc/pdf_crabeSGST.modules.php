...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_crabeSGST.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from crabeSGST model
 */
...
/**
 *	Class to manage PDF invoice template CrabeSGST
 */
class pdf_crabeSGST extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->option_tva = 1;                     // Manage option Vat Vat Invoice
		$this->option_modereg = 1;                 // Show mode regulation
		$this->option_condreg = 1;                 // Display Terms and Conditions
		$this->option_codeproduitservice = 1;      // Display Product Service code
		$this->option_multilang = 1;               // Available in Multilanguage
		$this->option_escompte = 1;                // Display if there was a Discount
		...
		if ($conf->facture->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				if ($object->situation_cycle_ref)
				{
					...
					$progress_width = 20;
					$this->posxlocaltax2 -= $progress_width;
